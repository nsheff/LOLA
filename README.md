...
The public-facing permanent link for LOLA is [http://databio.org/lola](http://databio.org/lola). The bioconductor link is [http://bioconductor.org/packages/LOLA/](http://bioconductor.org/packages/LOLA/).
